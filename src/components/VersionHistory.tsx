...
import { getNoteSnapshots, getBlockVersions, rollbackBlock } from '../services/notesService';
import type { INoteSnapshot, IBlockVersion } from '../types/collaboration';
            ...
            {blockId ? (
              ...
              blockVersions.map((version, index) => (
                <div
                  ...
                  onClick={() => handleSelectVersion(version.id, version.content)}
                >
                  <div className="version-indicator">
                    <div className="version-dot" />
                    {index < blockVersions.length - 1 && <div className="version-line" />}
                  </div>
              ...
              snapshots.map((snapshot, index) => (
                <div
                  ...
                  onClick={() => handleSelectVersion(snapshot.id, JSON.stringify(snapshot.blocks))}
                >
                  <div className="version-indicator">
                    <div className="version-dot" />
                  ...
                  <div className="version-info">
                    <div className="version-time">{formatTime(snapshot.createdAt)}</div>
                    <div className="version-user">
